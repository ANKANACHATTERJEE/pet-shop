...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM `pet-shop`.`login` WHERE username = ?";
...
{
    $sql = "INSERT INTO `pet-shop`.`login` (username, password) VALUES (?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt)
    {
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="bar">
        <span class="login active"><a href="login.php" aria-current="page">Login / Register</a></span>
